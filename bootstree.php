    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
       ...
       <div class="container">
        ...
        <form action="bootstree.php" method="post">

          <div class="row">
        <div class="span4">
          <h2>Fråga 1</h2>
          <img src="images/php.png" class="img-polaroid" width="300px" height="300px">
          <p> En fråga, svar </p>
          

            <select name="ett">
             <option name="ett" id="ett" value="1">1</option>
              <option name="ett" id="ett" value="X">X</option>
              <option name="ett" id="ett" value="2">2</option>
            </select>
         ...
         <div class="span4">
          ...
          <form>
            ...
            <select name="two" >
             <option  name="two" id="two" value="1">1</option>
              <option name="two" id="two" value="X">X</option>
         ...
         <div class="span4">
          ...
          <form>
            ...
            <select name="tre" >
             <option  name="tre" >1</option>
              <option  name="tre" id="tre" value="X">X</option>
              <option  name="tre" id="tre" value="2" >2</option>
            </select>
            <br>
         ...
         <?php
            ...
            echo "<p> Du har totalt: ". $totalCorrect ." rätt </p>";
